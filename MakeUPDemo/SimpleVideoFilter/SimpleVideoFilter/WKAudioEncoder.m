...
@implementation WKAudioEncoder
{
    WKEncoderAudioDataReadyBlock dataReadyBlock;
}
...
{
    WKAudioEncoder *encoder = (__bridge WKAudioEncoder *)(inUserData);
